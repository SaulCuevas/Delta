...
class ESTADISTICAS(QWidget):
    ...
    def __init__(self):
        ...
        lbl_estadisticas = QLabel("ESTADÍSTICAS")
        lbl_estadisticas.setAlignment(Qt.AlignCenter)
        lbl_estadisticas.setStyleSheet("border: 1px solid black; background-color: lightgreen")
        w = lbl_estadisticas.sizeHint().width() + 10
