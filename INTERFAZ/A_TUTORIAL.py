...
class TUTORIAL(QWidget):
    ...
    def __init__(self):
        ...
        lbl_tutorial = QLabel("TUTORIAL")
        lbl_tutorial.setAlignment(Qt.AlignCenter)
        lbl_tutorial.setStyleSheet("border: 1px solid black; background-color: lightgreen")
        w = lbl_tutorial.sizeHint().width() + 10
        h = lbl_tutorial.sizeHint().height()
