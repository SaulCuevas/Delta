...
class CMANUAL(QWidget):
    ...
    def __init__(self, port):
        ...
        self.port = port
        self.ser = esp.start_serial(self.port)
        self.period = 100
        self.timer = QTimer()
        self.timer.setInterval(self.period)
        self.timer.timeout.connect(self.read_encoders)
        self.inc = 0.00
        self.last_tool = 1
        ...
        # 12. Label 08: Valor de VELOCIDAD seleccionada
        # 13. Label 09: Etiqueta de titulo para coordenadas actuales COORD LAYOUT
        # 14. Switch 01: TOOGLE BUTTON para cambio de medida angulo en COORD LAYOUT
        # 15. Label 10: Etiqueta coordenadas X/M1 COORD LAYOUT
        # 16. LineEdit 01: Valor FIJO coordenadas X/M1 COORD LAYOUT
        # 17. LineEdit 02: Valor MEDIDO coordenadas X/M1 COORD LAYOUT
        # 18. Label 11: Dimension coordenadas X/M1 COORD LAYOUT
        # 19. Label 12: Etiqueta coordenadas Y/M2 COORD LAYOUT
        # 20. LineEdit 03: Valor FIJO coordenadas Y/M2 COORD LAYOUT
        # 21. LineEdit 04: Valor MEDIDO coordenadas Y/M2 COORD LAYOUT
        # 22. Label 13: Dimension coordenadas Y/M2 COORD LAYOUT
        # 23. Label 14: Etiqueta coordenadas Z/M3 COORD LAYOUT
        # 24. LineEdit 05: Valor FIJO coordenadas Y/M2 COORD LAYOUT
        # 25. LineEdit 06: Valor MEDIDO coordenadas Z/M3 COORD LAYOUT
        # 26. Label 15: Dimension coordenadas Z/M3 COORD LAYOUT
        # 27. Button 01: Flecha de acción -> fijar nuevas coordenadas ACTION LAYOUT
        # 28. Button 02: Flecha de acción -> enviar comando a PORT ACTION LAYOUT
        # 29. Label 16: Etiqueta de titulo para coordenadas nuevas NEW LAYOUT
        # 30. LineEdit 07: Valor NUEVO coordenadas X/M1 NEW LAYOUT
        # 31. LineEdit 08: Valor NUEVO coordenadas Y/M2 NEW LAYOUT
        # 32. LineEdit 09: Valor NUEVO coordenadas Z/M3 NEW LAYOUT
        # 33. Button 03 [M1-]: Desplazamiento negativo en Motor 1
        # 34. Button 04 [M1+]: Desplazamiento positivo en Motor 1
        # 35. Button 05 [M2-]: Desplazamiento negativo en Motor 2
        # 36. Button 06 [M2+]: Desplazamiento positivo en Motor 2
        # 37. Button 07 [M3-]: Desplazamiento negativo en Motor 3
        # 38. Button 08 [M3+]: Desplazamiento positivo en Motor 3
        # 39. Button 09 [X-]: Desplazamiento en X negativo coordenadas rectangulares
        # 40. Button 10 [X+]: Desplazamiento en X positivo coordenadas rectangulares
        # 41. Button 11 [Y-]: Desplazamiento en Y negativo coordenadas rectangulares
        # 42. Button 12 [Y+]: Desplazamiento en Y positivo coordenadas rectangulares
        # 43. Button 13 [Z-]: Desplazamiento en Z negativo coordenadas rectangulares
        # 44. Button 14 [Z+]: Desplazamiento en Z positivo coordenadas rectangulares
        # 45. Switch 02: TOOGLE BUTTON para cambio de coordenadas CONTROL POS LAYOUT
        # 46. Label 17: Etiqueta de tipo de COORDENADAS actual
        # 47. Label 18: Etiqueta panel de herramientas TOOL LAYOUT
        # 48. Button 15: Iniciar uso de CONTROL MANUAL
        # 49. Label 19: Etiqueta herramienta desactivada TOOL LAYOUT
        # 50. Widget 01: INVENTORY/DISABLE TOOL WIDGET
        # 51. Label 20: Etiqueta herramiental ninguna TOOL LAYOUT
        # 52. Widget 02: NONE TOOL WIDGET
        # 53. Label 21: Etiqueta herramienta cámara TOOL LAYOUT
        # 54. Widget 03: CAMERA TOOL WIDGET
        # 55. Label 22: Etiqueta herramienta soldadura TOOL LAYOUT
        # 56. Widget 04: SOLDADURA TOOL WIDGET
        # 57. Label 23: Etiqueta herramienta p&p TOOL LAYOUT
        # 58. Widget 05: PICK & PLACE TOOL WIDGET
        # 59. Button 16: Volver a MENU
    ...
    # ----- STYLE VARIABLES -----------------------------------------------------
        ...
        # Style Slider
        st_sld = "QSlider {"
        st_sld += "border: 0px solid #999999; "
        st_sld += "border-radius: 10px; "
        st_sld += "}"

        st_sld += "QSlider::groove:horizontal {"
        st_sld += "border: 1px solid #bbb; "
        st_sld += "height: 15px; "
        st_sld += "background: white; "
        st_sld += "border-radius: 6px;"
        st_sld += "}"
        ...
        st_sld += "width: 18px; "
        st_sld += "margin-top: -2px; "
        st_sld += "margin-bottom: -2px; "
        st_sld += "border-radius: 8px; "
        st_sld += "}"

        st_sld += "QSlider::handle:horizontal:hover {"
        st_sld += "background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #fff, stop:1 #ddd); "
        st_sld += "border: 1px solid #444; "
        st_sld += "border-radius: 6px; "
        st_sld += "}"
...
# ------- TOP LAYOUT (ACCESO DATOS RAPIDO) ------------------------------------------------------
        ...
        self.top_typeh = QLabel("D/I/P/C/S/P")    # Generar Label Valor HERRAMIENTA
...
# ------- MIDDLE LAYOUT -------------------------------------------------------
    ...
    # ----- LAYOUT HERRAMIENTA (VERTICAL 1) ---------------------------------------------
        ...
        items = ["DESACTIVADO", "INVENTARIO", "POLEA", "CÁMARA", "SOLDADURA", "PICK & PLACE"]   # Lista de Valores para ComboBox
    ...
    # ----- LAYOUT VELOCIDAD (VERTICAL 2) ---------------------------------------------
        ...
        # Label 08: Valor de VELOCIDAD seleccionada
    ...
    # ***** MEASURE LAYOUT ****************************
        ...
        # Label 09: Etiqueta de titulo para coordenadas actuales COORD LAYOUT
    ...
    # ***** X LAYOUT ****************************
        ...
        # Label 10: Etiqueta coordenadas X/M1 COORD LAYOUT
        ...
        # Label 11: Dimension coordenadas X/M1 COORD LAYOUT
    ...
    # ***** Y LAYOUT ****************************
        ...
        # Label 12: Etiqueta coordenadas Y/M2 COORD LAYOUT
        ...
        # Label 13: Dimension coordenadas Y/M2 COORD LAYOUT
    ...
    # ***** Z LAYOUT ****************************
        ...
        # Label 14: Etiqueta coordenadas Z/M3 COORD LAYOUT
        ...
        # Label 15: Dimension coordenadas Z/M3 COORD LAYOUT
    ...
    # ----- LAYOUT NUEVAS COORD (VERTICAL 5) ---------------------------------------------
        ...
        # Label 16: Etiqueta de titulo para coordenadas nuevas NEW LAYOUT
...
# ------- BOTTOM LAYOUT -------------------------------------------------------
    ...
    # ----- LAYOUT CONTROL POSICION (VERTICAL 6) ---------------------------------------------
        ...
        self.sw_coord.setStyleSheet("")   # Fijar estilo de widget
        ...
        # Label 17: Etiqueta de tipo de COORDENADAS actual
    ...
    # ***** BEGIN LAYOUT ***************************
        ...
        # Label 18: Etiqueta panel de herramientas TOOL LAYOUT
    ...
    # ***** DISABLE LAYOUT ***************************
        ...
        # Label 19: Etiqueta herramienta desactivada TOOL LAYOUT
    ...
    # ***** INVENTORY LAYOUT ***************************
        ...
        # Widget 01: INVENTORY/DISABLE TOOL WIDGET
    ...
    # ***** POLEA LAYOUT ***************************
        ...
        # Label 20: Etiqueta herramiental ninguna TOOL LAYOUT
    ...
    # ***** CAMERA LAYOUT ***************************
        ...
        # Label 21: Etiqueta herramienta cámara TOOL LAYOUT
    ...
    # ***** SOLDERING LAYOUT ***************************
        ...
        # Label 22: Etiqueta herramienta soldadura TOOL LAYOUT
        ...
        # Widget 04: SOLDADURA TOOL WIDGET
    ...
    # ***** PICK & PLACE LAYOUT ***************************
        ...
        # Label 23: Etiqueta herramienta p&p TOOL LAYOUT
        ...
        # Widget 05: PICK & PLACE TOOL WIDGET
...
# ------- FUNCIONES ADICIONALES -------------------------------------------
    ...
    # FUNCIÓN PARA INICIAR OPERACIÓN
    ...
    def read_encoders(self):
        ...
        try:
            ...
            self.y_val = value[1]
            self.z_val = value[2]
            self.pnp_val = value[3]
            self.chtool_val = value[4]
            self.invent_val = value[5]
            self.act_mediciones()
