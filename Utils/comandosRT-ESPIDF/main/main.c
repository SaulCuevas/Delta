...
const float zeros[6] = {3.433049, 4.424001, 2.911879, 0.0, 0.0, 0.772873};
float amplitud = 0.0;
float periodo = 0.0;
...
float Kp[6] = {55.3068, 54.9594,    54.1958,    94.6384,    865.5567,   865.5567/4};
float Ki[6] = {12.0,    12.0,       12.0,       5.0,        0.0,        0.0};
float Kd[6] = {1.6972,  1.9189,     1.7756,     10.1249,    57.3356,    57.3356/4};
